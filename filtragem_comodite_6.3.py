...
file_principal = '/home/rila/Área de Trabalho/O PROGETO/tabela_atualizada_principal_2.ods'
file_novo = '/home/rila/Área de Trabalho/O PROGETO/nova_lista_comodites_2.ods'
df_principal = pd.read_excel(file_principal)
df_novo = pd.read_excel(file_novo)

df_novo[['value', 'B']] = df_novo['A'].str.split(', ', 2, expand=True)
df_novo[['value', 'B']] = df_novo['A'].str.split(' ', 1, expand=True)
...
#file_resultado.to_excel('/home/rila/Área de Trabalho/O PROGETO/teste_DF_resultado_4.2.ods')
