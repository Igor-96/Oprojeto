...
df_principal['Id'] = ['minerais?' for i in df_principal['Comodites']]

df_novo['value'] = df_novo['value']

df_novo['value'] = [str(i) for i in df_novo['value']]
...
file_resultado = df_final.drop(columns = ['level_0', 'index', 'Unnamed: 0'])
